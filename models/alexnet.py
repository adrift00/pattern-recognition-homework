...
class AlexNet(nn.Module):
    # NOTE: The code of the difinition of alexnet is inspired by torchvision, link is https://github.com/pytorch/vision/blob/master/torchvision/models/alexnet.py .
